...
import static com.osdam.osdam.domain.DepartamentoAsserts.*;
...
class DepartamentoResourceIT {
    ...
    public static Departamento createEntity() {
        return new Departamento().name(DEFAULT_NAME);
    }
    ...
    public static Departamento createUpdatedEntity() {
        return new Departamento().name(UPDATED_NAME);
    }
    ...
    void putExistingDepartamento() throws Exception {
        ...
        updatedDepartamento.name(UPDATED_NAME);
    ...
    void partialUpdateDepartamentoWithPatch() throws Exception {
        ...
        partialUpdatedDepartamento.name(UPDATED_NAME);

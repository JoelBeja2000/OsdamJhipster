...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSCRIPCIONES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSCRIPCIONES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSCRIPCIONES actions', async () => {
      const arg = { id: 24978 };
    ...
    it('dispatches UPDATE_INSCRIPCIONES actions', async () => {
      const arg = { id: 24978 };
    ...
    it('dispatches PARTIAL_UPDATE_INSCRIPCIONES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSCRIPCIONES actions', async () => {
      const arg = 42666;

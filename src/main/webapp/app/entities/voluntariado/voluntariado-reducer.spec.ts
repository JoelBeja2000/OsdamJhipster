...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOLUNTARIADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOLUNTARIADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOLUNTARIADO actions', async () => {
      const arg = { id: 11319 };
    ...
    it('dispatches UPDATE_VOLUNTARIADO actions', async () => {
      const arg = { id: 11319 };
    ...
    it('dispatches PARTIAL_UPDATE_VOLUNTARIADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOLUNTARIADO actions', async () => {
      const arg = 42666;

  ...
  return (
    <div>
      <h2 id="departamento-heading" data-cy="DepartamentoHeading">
        <Translate contentKey="osdamApp.departamento.home.title">Departamentos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="osdamApp.departamento.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/departamento/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="osdamApp.departamento.home.createLabel">Create new Departamento</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departamentoList && departamentoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="osdamApp.departamento.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="osdamApp.departamento.name">Name</Translate>{' '}
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/departamento/${departamento.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="osdamApp.departamento.home.notFound">No Departamentos found</Translate>
            </div>
          )
        )}
      </div>
